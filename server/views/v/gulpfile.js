...
gulp.task('less', function() {
    return gulp.src('web/less/sb-admin-2.less')
        .pipe(less())
...
gulp.task('minify-css', ['less'], function() {
    return gulp.src('web/dist/css/sb-admin-2.css')
...
gulp.task('js', function() {
    return gulp.src(['web/js/sb-admin-2.js'])
        .pipe(header(banner, { pkg: pkg }))
...
gulp.task('dev', ['browserSync', 'less', 'minify-css', 'js', 'minify-js'], function() {
    ...
    gulp.watch('web/dist/css/*.css', ['minify-css']);
